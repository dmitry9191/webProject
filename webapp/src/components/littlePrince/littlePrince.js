...
const LittlePrince = () => {
    return (
        ...
        /* <wbr> переносит тэг только если это необходимо */
        /* <time>Тэг времени</time> */
        <div>
            ...
            <hr/>
            <h3 className="chapterNumber">I</h3>
            <p>Once when I was six years old I saw a magnificent picture in a book, called <span className="italic">True Stories from Nature</span>, about the primeval forest. It was a picture of a boa constrictor in the act of swallowing an animal. Here is a copy of the drawing.</p>
            <img src={hroznys} alt={"hroznys"} />
            <p>In the book it said: <span className="italic">"Boa constrictors swallow their prey whole, without chewing it. After that they are not able to move, and they sleep through the six months that they need for digestion.</span>"</p>
            ...
            <p>But they answered: <span className="italic">"Frighten? Why should any one be frightened by a hat?"</span></p>
            ...
            <p><span className="italic">"That is a hat."</span></p>
            ...
            <hr></hr>
            <h3 className="chapterNumber">II</h3>
            ...
            <p><span className="italic">"If you please--draw me a sheep!"</span></p>
            <p><span className="italic">"If you please--draw me a sheep!"</span></p>
            <p><span className="italic">"Draw me a sheep!"</span></p>
            <p>I jumped to my feet, completely thunderstruck. I blinked my eyes hard. I looked carefully all around me. And I saw a most extraordinary small person, who stood there examining me with great seriousness. Here you may see the best portrait that, later, I was able to make of him. But my drawing is certainly very much less charming than <span className="through">its</span> model.</p>
            ...
            <p><span className="italic">"But--what are you doing here?"</span></p>
            ...
            <p><span className="italic">"That doesn't matter. Draw me a sheep..."</span></p>
            ...
            <p><span className="italic">"No, no, no! I do not want an elephant inside a boa constrictor. A boa constrictor is a very dangerous creature, and an elephant is very cumbersome. Where I live, everything is very small. What I need is a sheep. Draw me a sheep."</span></p>
            <p>So then I made a drawing.</p>
            <img src={nemocnyBeranek} alt={"nemocnyBeranek"} />
            <p>He looked at it carefully, then he said:</p>
            <p><span className="italic">"No. This sheep is already very sickly. Make me another."</span></p>
            <p>So I made another drawing.</p>
            <img src={beranek} alt={"beranek"} />
            <p>My friend smiled gently and indulgently.</p>
            <p><span className="italic">"You see yourself," he said, "that this is not a sheep. This is a ram. It has horns."</span></p>
            <p>So then I did my drawing over once more.</p>
            <p>But it was rejected too, just like the others.</p>
            <p><span className="italic">"This one is too old. I want a sheep that will live a long time."</span></p>
            ...
            <p><span className="italic">"This is only his box. The sheep you asked for is inside."</span></p>
            <p>I was very surprised to see a light break over the face of my young judge:</p>
            <p><span className="italic">"That is exactly the way I wanted it! Do you think that this sheep will have to have a great deal of grass?"</span></p>
            <p><span className="italic">"Why?"</span></p>
            <p><span className="italic">"Because where I live everything is very small..."</span></p>
            <p><span className="italic">"There will surely be enough grass for him," I said. "It is a very small sheep that I have given you."</span></p>
            <p>He bent his head over the drawing.</p>
            <p><span className="italic">"Not so small that--Look! He has gone to sleep..."</span></p>
